        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Jadwal Pelayanan Dokter Spesialis</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item">Posting</li>
                            <li class="breadcrumb-item">Jadwal Pelayanan</li>
                            <li class="breadcrumb-item active">Dokter Spesialis</li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="hstack gap-3">
                            <button type="button" class="btn btn-primary" onclick="window.location='{{ route('admin.jadwal.create') }}'"><i class="mdi mdi-plus-thick"></i> Tambah</button>
                            <div class="vr"></div>
                            <div class="btn-group">
