                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Poster Kesehatan</li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="hstack gap-3">
                            <button type="button" class="btn btn-primary" onclick="window.location='{{ route('admin.eposter.create') }}'"><i class="mdi mdi-plus-thick"></i> Tambah</button>
                            <div class="vr"></div>
                            <div class="btn-group">
                                ...
                                <td>
                                    <center>
                                        <div class="btn-group" role="group">
                                            ...
                                            <button type="button" class="btn btn-warning btn-sm" onclick="window.location='{{ url('admin/posting/eposter/${item.id}/edit') }}'"><i class="fa-fw fas fa-edit nav-icon text-white"></i></button>
    ...
    function showLampiran(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "./eposter/"+id;
            }
        })
    }
    function hapus(id) {
        Swal.fire({
            ...
            text: 'Hapus Poster Kesehatan ID : '+id,
            icon: 'warning',
